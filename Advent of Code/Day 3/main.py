...
if __name__ == "__main__":
    ...
    part_1_ans = exercisethree_part_1(diagnostic_report)
    print(part_1_ans)

    part_2_ans = exercisethree_part_2(diagnostic_report)
    print(part_2_ans)